...
import com.zym.javaweb.mvc.dao.CriteriaCustomer;
import com.zym.javaweb.mvc.dao.CustomerDAO;
import com.zym.javaweb.mvc.dao.factory.CustomerDAOFactory;
import com.zym.javaweb.mvc.dao.impl.CustomerDAOJdbcImpl;
import com.zym.javaweb.mvc.domain.Customer;

public class CustomerServlet extends HttpServlet {

//	CustomerDAOFactory customerDAOFactory = CustomerDAOFactory.getInstance();
//	customerDAOFactory.setType("jdbc");
...
//	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String methodName = servletPath.substring(8);
	...
	private void edit(HttpServletRequest request, 
		...
		try {
			...
			if(customer != null){
				forwardPath = "/mvcJsp/updatecustomer.jsp";
	...
	private void query(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		request.getRequestDispatcher("/mvcJsp/index.jsp").forward(request, response);
	}
	...
	private void addCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		if(count > 0){
			...
			//来进行回显
			//2.2.3 结束方法: return 
			request.getRequestDispatcher("/mvcJsp/newcustomer.jsp").forward(request, response);
			return;
		}
